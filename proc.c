...
int menu(){
  ...
  cprintf("cps              \t Display all the current process states along with priority\n");
  cprintf("chpr (pid,pr)    \t Change process priority\n");
  cprintf("shutdown         \t Shutdown from qemu\n");
  //cprintf("Command name \t Description\n");
  return 25;
}
